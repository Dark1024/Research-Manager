...
class TextsControllerTest < ActionController::TestCase
  ...
  test "should create text" do
    assert_difference('Text.count') do
      post :create, text: { article_id: @text.article_id, author_number: @text.author_number, researcher_id: @text.researcher_id }
    end
  ...
  test "should update text" do
    patch :update, id: @text, text: { article_id: @text.article_id, author_number: @text.author_number, researcher_id: @text.researcher_id }
    assert_redirected_to text_path(assigns(:text))
  end
