...
class ResearchersControllerTest < ActionController::TestCase
  ...
  test "should create researcher" do
    assert_difference('Researcher.count') do
      post :create, researcher: { email: @researcher.email, first_name: @researcher.first_name, last_name: @researcher.last_name, office_phone: @researcher.office_phone, phone: @researcher.phone }
    end
  ...
  test "should update researcher" do
    patch :update, id: @researcher, researcher: { email: @researcher.email, first_name: @researcher.first_name, last_name: @researcher.last_name, office_phone: @researcher.office_phone, phone: @researcher.phone }
    assert_redirected_to researcher_path(assigns(:researcher))
  end
