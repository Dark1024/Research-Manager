...
class FacultiesControllerTest < ActionController::TestCase
  ...
  test "should create faculty" do
    assert_difference('Faculty.count') do
      post :create, faculty: { description: @faculty.description, name: @faculty.name, university_id: @faculty.university_id }
    end
  ...
  test "should update faculty" do
    patch :update, id: @faculty, faculty: { description: @faculty.description, name: @faculty.name, university_id: @faculty.university_id }
    assert_redirected_to faculty_path(assigns(:faculty))
  end
